...
function LoginForm() {
  ...
  return (
    <div style={{ background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '32px' }}>
      <h1 style={{ fontSize: '18px', fontWeight: 600, color: '#ededed', marginBottom: '24px', textAlign: 'center' }}>Sign in</h1>
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#080808', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '400px', padding: '24px' }}>
        ...
        <Suspense fallback={
          <div style={{ background: '#0d0d0d', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '32px', textAlign: 'center', color: '#6b6b66', fontSize: '13px' }}>
            Loading…
          </div>
        }>
          <LoginForm />
